...
public class MainActivity extends AppCompatActivity implements OnPdfFileSelectListener {
    ...
    public ArrayList<File> findPfd (File file)
    {
        ...
        for (File singleFile: files)
        {
            if (singleFile.isDirectory() && !singleFile.isHidden()){
                arrayList.addAll(findPfd(singleFile));
            }
            else {
    ...
    private void displayPdf() {
        ...
        pdfList.addAll(findPfd(Environment.getExternalStorageDirectory()));
